  ...
  return (
    <section className="flex flex-col md:flex-row items-center px-4 mb-3">
      <div className="order-1 md:order-2 w-full md:w-1/2 p-4 text-center">
        ...
        <Link href="/gallery" className='inline-block px-6 py-2 my-3 text-white bg-[#312F2F] rounded hover:bg-[#474646] md:px-12 md:py-3 md:text-xl lg:text-2xl mt-5'>Galleria</Link>
      </div>
